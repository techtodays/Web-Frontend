const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=d2c90ad44951af43f107a0a469f8dc50&units=imperial';
fetch(apiURL)
  ...
  const apiURL1 = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=d2c90ad44951af43f107a0a469f8dc50&units=imperial';
  fetch(apiURL1)
    .then((response) => response.json())
    .then((jsObject) => {
      console.log(jsObject);
